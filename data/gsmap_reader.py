...
#filename1='satellite_data/hokusai.eorc.jaxa.jp/standard/v6/hourly/2002/01/01/gsmap_rnl.20020101.0000.v6.5133.0.dat.gz'
...
#gsm_out = 'satellite_data/GSMaP.v7_0.10deg_2001.nc'
gsm_out = 'satellite_data/hokusai.eorc.jaxa.jp/standard/v6/hourly/test.nc'
year = '2002'
...
#	time= pd.date_range(ym+'2001-01-01','2001-12-31', freq='1H')
	...
	path = 'satellite_data/hokusai.eorc.jaxa.jp/standard/v6/hourly/2002/'
